...
export default function NoiseDarkBlueGradientBackground({
  showGrid = true,
  direction = "diagonal",
  speed = 0.6,
  squareSize = 48,
  ...
  hoverStrokeColor = "rgba(6,182,212,0.40)",
  hoverGlowColor   = "rgba(6,182,212,0.25)", 
  className = "",
}: CombinedProps) {
  ...
  return (
    <div className={`fixed inset-0 -z-10 bg-[#04070d]/92 ${className}`}>
      {/* soft spotlight tone */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_900px_at_50%_200px,rgba(6,182,212,0.08),transparent_75%)]" />
      ...
      <div className="pointer-events-none absolute inset-0 z-30">
        <Noise refresh={2} alpha={8} />
      </div>
      <div className="pointer-events-none absolute inset-0 z-40 bg-gradient-to-b from-transparent via-transparent to-[#04070d]/90" />
    </div>
  );
}
